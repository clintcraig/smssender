...
//                    Log.i("Income Messages", msg.toString());
		            ...
		            Toast.makeText(getApplicationContext(), "Database has been Created", Toast.LENGTH_SHORT).show();
...
//		Log.i("sqlCreate", Boolean.toString(sqlCreated));
		...
		btnSend.setOnClickListener(new Button.OnClickListener()
		{
			...
			public void onClick(View v) {
				...
				{
					Toast.makeText(getApplicationContext(), "Please check phone number and message", Toast.LENGTH_SHORT).show();
				}
				else
				{
					String [] smsNumberGroup=smsNumber.split(";");
					SmsManager smsManager = SmsManager.getDefault(); 
					PendingIntent pintent = PendingIntent.getBroadcast(Send.this, 0, new Intent("SMS_SENT"), 0);
				    ...
				    smsManager.sendTextMessage(smsNumberGroup[i], null, smsContent, pintent, null);  
					Toast.makeText(getApplicationContext(), "Number is :"+smsNumberGroup[i].toString()+"SMS Content is :" +inputMsg.getText().toString(), Toast.LENGTH_SHORT).show();
					}
				}
	...
	//override run() method to implement init database and send Msg to main Thread
