	...
	public BroadcastReceiver smsReciever = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			case Activity.RESULT_OK:
				...
				appWidgetMannager = AppWidgetManager.getInstance(SmsService.this);
				remoteViews = new RemoteViews(SmsService.this.getPackageName(), R.layout.widget);
                componentName = new ComponentName(SmsService.this,AppWidget.class);
